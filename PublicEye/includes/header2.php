...
<header>
  ...
  <nav id="nav-links">
    ...
    <div class="dropdown nav-item">
      <a href="#" style="text-decoration: none; color: black;">Project</a>
      <div class="dropdown-content">
        <a href="admin_project.php" style="text-decoration: none; color: black;">View Projects</a>
        <a href="admin_create.php" style="text-decoration: none; color: black;">Create Project's Form</a>
      </div>
    </div>
