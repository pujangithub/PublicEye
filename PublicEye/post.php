...
<div class="contractor-name" style="font-weight: 600; color: #444;">Contractor Name: <a href="project_details.php?id=<?php echo $tender_user_id; ?>" style="color: #444; text-decoration: none;"><?php echo htmlspecialchars($contractor_name); ?></a></div>
          ...
          <div class="post-menu" style="position: absolute; top: 2px; right: 10px; cursor: pointer; user-select: none;">
            ...
            <div class="post-menu-dropdown" style="display: none; position: absolute; right: 0; background: white; border: 1px solid #ccc; border-radius: 5px; box-shadow: 0 2px 8px rgba(0,0,0,0.15); z-index: 100;">
              <button class="report-post-btn" style="background: none; border: none; padding: 10px 20px; width: 150px; text-align: left; cursor: pointer; font-size: 14px; color: #d9534f;">
                Report Post
              </button>
            </div>
          </div>
  ...
  <script>
    ...
    // Report post button click handler
