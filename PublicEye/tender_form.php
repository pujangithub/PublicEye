  ...
  <div class="form-container">
    <form method="post" action="tender_form_process.php" enctype="multipart/form-data" id="tenderForm">
      <fieldset>
        ...
        <?php
        $standard_labels = ['Contractor Name', 'Location', 'Contact Number', 'Contact Email', 'Budget', 'Start Date', 'Expected End Date'];
        ...
        <?php if (!empty($picture)) : ?>
          <div style="margin-bottom: 10px;">
            <img src="uploads/<?php echo htmlspecialchars($picture); ?>" alt="Current Picture" style="max-width: 150px; max-height: 150px; border-radius: 8px;">
          </div>
        <?php endif; ?>
